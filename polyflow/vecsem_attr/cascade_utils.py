...
import polyflow
from polyflow.types import CascadeArgs
...
def learn_cascade_thresholds(
    ...
    polyflow.logger.info(f"Sample recall: {recall(best_combination[0], best_combination[1], no_correction_sorted_pairs)}")
    polyflow.logger.info(f"Sample precision: {precision(best_combination[0], best_combination[1], sorted_pairs)}")
