...
""" 
This code is a modified version of the sem_hybrid_classify method. It is designed to work with the NumPy library instead of the Polyflow library.
 """



@pd.api.extensions.register_dataframe_accessor("np_sem_hybrid_classify")
class NpSemHybridClassifyAccessor:
    ...
    def __call__(
        ...
        if not prompt_template:
            prompt_template = (
                ...
                "Provide a confident classification with clear reasoning."
            )
    ...
    def _classify_text(
        ...
        try:
            ...
            system_prompt = (
                "You are an expert text classifier. Analyze the given text and categorize it. "
                "Respond with ONLY a valid JSON object in this exact format:\n"
                '{"category": "<category>", "confidence": <0.0-1.0>, "reasoning": "<explanation>"}\n'
